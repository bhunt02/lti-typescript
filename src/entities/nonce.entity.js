...
var NonceModel = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('nonce_model')];
    ...
    var NonceModel = _classThis = (function (_super) {
        __extends(NonceModel_1, _super);
        function NonceModel_1() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.nonce = __runInitializers(_this, _nonce_initializers, void 0);
            _this.createdAt = (__runInitializers(_this, _nonce_extraInitializers), __runInitializers(_this, _createdAt_initializers, void 0));
    ...
    __setFunctionName(_classThis, "NonceModel");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _nonce_decorators = [(0, typeorm_1.PrimaryColumn)({ type: 'text' })];
        ...
        NonceModel = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return NonceModel = _classThis;
}();
