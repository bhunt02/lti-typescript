...
export declare function register(encryptionKey: string, databaseOptions: Omit<DataSourceOptions, 'subscribers' | 'migrations' | 'migrationsTableName' | 'migrationsTransactionMode' | 'namingStrategy' | 'logging' | 'logger'>, options: ProviderOptions): Promise<Provider>;
